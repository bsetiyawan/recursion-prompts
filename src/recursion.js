...
var sum = function(array) {
	if (array === undefined) {
		...
		copyArrays = array.flat(Infinity)
		return copyArrays.pop() + sum(copyArrays);
	}
};
...
var arraySum = function(array) {
	if (array === undefined) {
		...
		//flat the array to one dimension array regardless original depth of array
		var copyArrays = array.flat(Infinity);
		return copyArrays.pop() + arraySum(copyArrays);
	}
};
...
var palindrome = function(string) {
	...
	var newString = trimmedString(string);
	...
	if ((newString.length === 2) && (newString[0] === newString[1])){
		return true;
	} else if ((newString.length === 2) && (newString[0] !== newString[1])){
		return false;
	} 
